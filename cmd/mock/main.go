...
func main() {
	...
	for ; number > 0; number-- {
		...
		offer := model.Offer{
			...
			Description: fmt.Sprintf("I have %d grams of %s to give away", int(rand.Float64()*1000), typ),
		}
